...
#   attachment = 'https://s3-us-west-2.amazonaws.com/marble-image-labeling/scale_drivable_v0/cloud_0000%s.json' % str(frame).zfill(4)
#   print attachment
#   attachments.append(attachment)

payload = {
  'callback_url': 'http://www.example.com/callback',
    'instruction': 'Please label 3D splines with drivable area',
